            ...
            <div className="lg:col-span-7">
              <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <InfoCard label="First Name" value="Usama" icon="👤" />
                  <InfoCard label="Last Name" value="Rafaqat" icon="👔" />
                  <InfoCard label="Age" value="23 Years" icon="🎂" />
                  <InfoCard label="Nationality" value="Pakistani" icon="🌍" />
                  <InfoCard label="Address" value="Sahiwal, PUNJAB, Pakistan" icon="📍" />
                  <InfoCard label="Phone" value="+92 3127953746" icon="📱" />
                  <InfoCard label="Email" value="chusama637@gmail.com" icon="✉️" fullWidth />
  ...
  >
            ...
            <div className="flex flex-col gap-6 mt-12 lg:col-span-5">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <StatCard title="Projects" value="5+" emoji="🚀" />
