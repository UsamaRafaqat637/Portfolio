        ...
        <div className="space-y-8">
          <div className="p-8 rounded-2xl bg-[#1a2430]/70 border border-gray-700 shadow-[0_4px_20px_rgba(0,0,0,0.3)] backdrop-blur-sm">
            ...
            <div className="space-y-4 text-lg">
              <p>📞 <span className="text-yellow-400">Phone:</span> +92 312 7953746</p>
              <p>📧 <span className="text-yellow-400">Email:</span> chusama637@gmail.com</p>
              <p>📍 <span className="text-yellow-400">Location:</span> Sahiwal, PUNJAB, Pakistan</p>
            </div>
          </div>
